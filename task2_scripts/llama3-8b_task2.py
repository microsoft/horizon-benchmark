...
def build_prompt(history_titles, item_sep="|<SEP>|"):
    ...
    f"<im_start>user\nHistory: {joined} {item_sep} This was the user's Amazon product history.\n"
    f"Your task is to generate a set of 10 personalized search queries that reflect the user's interests and preferences. Try to balance diversity and serendipity with relevancy to the user history. These queries will be used to recommend the next product to the user.\n"
